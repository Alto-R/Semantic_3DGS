...
sys.path.insert(0, str(PROJECT_ROOT / "scripts" / "task1"))

from ade20k_ontology import ADE20K_NUM_CLASSES, load_ontology  # noqa: E402
from fuse_semantic_votes import (  # noqa: E402
    LabelBuilder,
    decide_vote_labels,
    merge_fill,
