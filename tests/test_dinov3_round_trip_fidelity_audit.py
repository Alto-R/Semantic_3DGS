...
class RoundTripFidelityAuditTest(unittest.TestCase):
    ...
    def test_scheduler_reuses_cache_and_is_permanently_report_only(self) -> None:
        ...
        self.assertIn("lift_dense_view_votes", source)
        self.assertIn("round_trip_fidelity_audit", source)
        self.assertNotIn("dinov3_segment_views", source)
        self.assertIn("dinov3_inference_rerun=0", source)
        self.assertIn("heldout_policy=exclude_target_camera_before_consensus", source)
