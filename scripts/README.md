...
| `slurm/slurm_task1_dinov3_reviewed_incremental_fill_scene.sbatch` | Build a fresh candidate v3 by applying explicit exact-QA component exclusions and filling only preferred-v2-unlabeled Gaussians, with complete semantic and SuperSplat QA |
