...
This directory preserves code and documentation that are not part of the active
pipeline. Archived material remains available for provenance and comparison but
must not be imported, scheduled, or presented as a maintained entry point.
...
The maintained code and documentation are indexed from the repository root
`README.md`.
